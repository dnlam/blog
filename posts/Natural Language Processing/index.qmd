...
![Transfer learning workflow for movie classifier](https://github.com/fastai/fastbook/blob/master/images/att_00027.png?raw=1){#fig-transfer-learning fig-caption="Transfer learning workflow for movie classifier."}

As shown in @fig-transfer-learning,